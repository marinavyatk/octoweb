          ...
          <div className={s.taskBlock}>
            ...
            <div className={s.images}>
              <div className={s.smallImg}>
                <Image src={caseData.img.small} alt="" fill sizes={'(max-width: 767px) 228px,(max-width: 1425px) 547px,(max-width: 1905px) 392px,536px'}/>
              </div>
              <div className={s.mediumImg}>
                <Image src={caseData.img.medium} alt="" fill sizes={'(max-width: 767px) 288px,(max-width: 1425px) 691px,(max-width: 1905px) 808px, 1104px'}/>
              </div>
            </div>
          </div>
        </div>
