...
export type CaseCircleProps = { caseCircles: CaseCircle[] } & ComponentPropsWithoutRef<'div'>
...
export const CaseCircleList = (props: CaseCircleProps) => {
    ...
    const CaseCircles = caseCircles.map(circle => {
        return <CaseCircle img={circle.img} caseId={circle.caseId} category={circle.category} key={circle.caseId}/>
    })
