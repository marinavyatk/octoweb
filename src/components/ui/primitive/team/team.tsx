...
import {TeamMember, TeamMemberIntro} from '../teamMemberIntro/teamMemberIntro.tsx';

export type TeamProps = { teamMembersInfo: TeamMember[] } & ComponentPropsWithoutRef<'div'>
...
export const Team = (props: TeamProps) => {
    ...
    return <div {...restProps} className={classNames}>
        <div className={s.firstCol}>
            <p>Разработка интернет-магазина — это командная работа, где каждый вносит свой профессиональный вклад для
                успешной реализации проекта.</p>
            {currentMemberCard}
        </div>
